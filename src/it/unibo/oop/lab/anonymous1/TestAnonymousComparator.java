...
public final class TestAnonymousComparator {
    ...
    public static void main(final String... args) {
         ...
         */
        /**
         * Use anonymous class for sort incrementally by age
         * sort list of getFollowedUsers by age of users from min to max
         */
        ...
        /**
         * Use anonymous class for sort incrementally by age
         * sort list of getFollowedUsers by age of users from max to min
         */
